...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-DsxKgMYZ.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-GsrsVVop.js");
		return {
			get "ErrorBoundary"() {
	...
	"6efdf509a785": async () => {
		const m = await import("./assets/page-B5yXlnLa.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	...
	"a7c2b21269ea": async () => {
		const m = await import("./assets/page-bZ-2Hwge.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"b49ea5cf04c0": async () => {
		const m = await import("./assets/page-DEK5CSoj.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"e16c1c1133d5": async () => {
		const m = await import("./assets/page-DiQzKP01.js");
		return { get "default"() {
			return m["default"];
		} };
	}
