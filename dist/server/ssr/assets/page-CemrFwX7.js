	...
	return {
		...
		papers: [
			...
			},
			{
				paper: "Viết",
				time: "90 phút",
				items: [item("Part 1", "Viết luận", "Viết bài luận phát triển lập luận theo hai ý cho sẵn.", "Write an essay on whether schools should prioritise independent research.", "học viên tự trả lời", "lập luận, liên kết, văn phong học thuật"), item("Part 2", "Viết báo cáo/đề xuất/đánh giá", "Chọn một nhiệm vụ viết đúng văn phong.", "Write a proposal for improving a community learning project.", "học viên tự trả lời", "mục đích giao tiếp và tổ chức ý")]
			},
			{
				paper: "Nghe",
				time: "khoảng 40 phút",
	...
	return {
		...
		papers: [
			...
			},
			{
				paper: "Viết",
				time: "90 phút",
				items: [item("Part 1", "Viết luận tổng hợp", "Viết bài luận tóm lược và đánh giá hai văn bản ngắn.", "Write an essay evaluating two views on cultural identity.", "học viên tự trả lời", "tổng hợp và đánh giá"), item("Part 2", "Viết bài/báo cáo/thư/đánh giá", "Chọn nhiệm vụ viết dài với văn phong chính xác.", "Write a report assessing a media project and recommending improvements.", "học viên tự trả lời", "giọng văn, sắc thái, tổ chức ý")]
			},
			{
				paper: "Nghe",
				time: "khoảng 40 phút",
	...
	},
	{
		...
		papers: [
			...
			},
			{
				...
				time: "90 phút",
				parts: 2,
				tasks: ["Viết luận bắt buộc", "Viết báo cáo/đề xuất/đánh giá/thư"]
			},
			{
				name: "Nghe",
				time: "khoảng 40 phút",
		...
		practice: [
			{
				title: "Biến đổi câu nâng cao",
				skill: "Sử dụng tiếng Anh",
				sample: "Dùng cấu trúc nâng cao để viết lại câu giữ nguyên nghĩa."
			},
			{
				title: "Viết đề xuất",
				skill: "Viết",
				sample: "Viết proposal có mục tiêu, đề xuất cụ thể và lý do thuyết phục."
			},
			{
				title: "Thảo luận quan điểm",
				skill: "Nói",
				sample: "So sánh lựa chọn, đánh giá ưu/nhược điểm và đi đến quyết định."
			}
		]
	},
	{
		...
		papers: [
			...
			},
			{
				...
				time: "90 phút",
				parts: 2,
				tasks: ["Viết luận tổng hợp", "Viết bài/báo cáo/thư/đánh giá"]
			},
			{
				name: "Nghe",
				time: "khoảng 40 phút",
		...
		practice: [
			{
				...
				skill: "Sử dụng tiếng Anh",
				sample: "Chọn từ/cụm từ chính xác theo sắc thái và văn phong."
			},
			{
				title: "Luận tổng hợp",
				skill: "Viết",
				sample: "Tóm lược, đánh giá và phát triển lập luận từ hai văn bản."
			},
			{
				title: "Tranh luận chuyên sâu",
				skill: "Nói",
				sample: "Phát triển quan điểm trừu tượng với ví dụ và phản biện."
			}
		]
	}
];
...
function testMaterial(test, paper) {
	...
	if (paper.paper.includes("Nghe")) return {
		label: "Listening script",
		text: `Narrator: You will hear a conversation about ${theme}. Listen carefully and answer the questions. Examiner: The speakers are planning an activity. ${facts.slice(0, 6).map((fact, index) => `Detail ${index + 1}: ${fact}.`).join(" ")} Speaker A: I think these details are important, so please write them carefully. Speaker B: Yes, I will check the names, numbers, places and objects before we finish.`
	};
	if (paper.paper.includes("Đọc") || paper.paper.includes("Viết") || paper.paper.includes("Sử dụng")) return {
		label: "Reading text",
		text: `Read the text. The article is about ${theme}. A group of learners took part in a short project and recorded the most useful information. ${facts.slice(0, 8).map((fact, index) => `Point ${index + 1}: ${fact}.`).join(" ")} The writer says that good preparation, clear instructions and a careful review helped the group complete the task successfully.`
	};
	return {
		label: "Speaking card",
...
function needsIllustration(paperName, item) {
...
function illustrationKind(paperName, item) {
...
function ExamIllustration({ paperName, item }) {
	if (!needsIllustration(paperName, item)) return null;
	const kind = illustrationKind(paperName, item);
	if (kind === "story") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "exam-illustration",
		"aria-label": "Picture story illustration",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "Picture story" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "story-strip",
			children: [
				[
					"1",
					"morning",
					"A learner opens a school bag."
				],
				[
					"2",
					"class",
					"Friends look at a project poster."
				],
				[
					"3",
					"park",
					"The group collects ideas outside."
				],
				[
					"4",
					"show",
					"They present the finished work."
				]
			].map(([number, label, caption]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "story-panel",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: number }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { children: label }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: caption })
				]
			}, number))
		})]
	});
	if (kind === "compare") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "exam-illustration",
		"aria-label": "Compare two pictures",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "Compare the pictures" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "compare-pictures",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "picture-panel sunny",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Picture A" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "scene-row",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { className: "sun" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { className: "bench" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { className: "person blue" })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Two students are planning an outdoor activity." })
				]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "picture-panel indoor",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Picture B" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "scene-row",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { className: "window" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { className: "desk" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { className: "person coral" })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Two students are working together in a classroom." })
				]
			})]
		})]
	});
	if (kind === "options") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "exam-illustration",
		"aria-label": "Choose from picture options",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "Choose A, B or C" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			].map(([letter, title, caption]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "picture-option",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: letter }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: title }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { className: `option-scene ${title}` }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: caption })
				]
			}, letter))
		})]
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "exam-illustration",
		"aria-label": "Large picture illustration",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "Large picture" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "large-picture",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "picture-sky",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "kite" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "cloud" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "sun" })
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "picture-ground",
					children: [
						[
							"Ben",
							"Daisy",
							...
							"Jack",
							"Mia"
						].map((name, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: `child child-${index + 1}`,
							children: name
						}, name)),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { className: "tree" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { className: "table" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { className: "ball" })
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Use the picture for matching names, finding objects, colouring, or short answers." })
			]
		})]
	});
}
function examTaskType(item) {
...
function examInstruction(paperName, item) {
	...
	if (paper.includes("viết")) return "Write your answer in English. Use the prompt, organise your ideas clearly and check grammar and spelling.";
...
function Home() {
	const [activeView, setActiveView] = (0, import_react.useState)("home");
	...
	const [doingTest, setDoingTest] = (0, import_react.useState)(false);
	const [testAnswers, setTestAnswers] = (0, import_react.useState)({});
	const [testChecked, setTestChecked] = (0, import_react.useState)(false);
	const [testAudioKey, setTestAudioKey] = (0, import_react.useState)(null);
	...
	const testScore = gradableItems.filter((item) => {
		return testAnswers[`${activePracticeTest.id}-${item.part}-${item.sampleQuestion}`]?.trim().toLowerCase() === item.answerKey.trim().toLowerCase();
	}).length;
	...
	const updateTestAnswer = (key, value) => setTestAnswers((current) => ({
		...current,
		[key]: value
	}));
	const openView = (view) => {
	...
	const playTestAudio = (key, text) => {
		window.speechSynthesis.cancel();
		if (testAudioKey === key) {
			setTestAudioKey(null);
			return;
		}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			activeView === "home" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			activeView === "roadmap" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "level-rail page-view",
				id: "roadmap",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			activeView === "exam" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "exam-section page-view",
				id: "exam-formats",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "section-heading",
					...
					activePracticeTest && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: activePracticeTest.papers.map((paper) => {
								const material = testMaterial(activePracticeTest, paper);
								const audioKey = `${activePracticeTest.id}-${paper.paper}`;
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
									className: "test-paper",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: paper.paper }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: paper.time })] }),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "test-material paper-material",
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: material.label }),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: material.text }),
												paper.paper.includes("Nghe") && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
													type: "button",
													onClick: () => playTestAudio(audioKey, material.text),
													children: testAudioKey === audioKey ? "Dừng audio" : "▶ Nghe audio"
												})
											]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: paper.items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: item.part }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("em", { children: examTaskType(item) })] }),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: examInstruction(paper.paper, item) }),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExamIllustration, {
													test: activePracticeTest,
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "Focus:" }),
													" ",
													examFocus(item)
												] })] })
			...
			activeView === "lessons" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "lesson-section page-view",
				id: "lessons",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "section-heading",
			...
			activeView === "progress" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "progress-section page-view",
				id: "progress",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			doingTest && activePracticeTest && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "exam-modal",
				role: "dialog",
				"aria-modal": "true",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "modal-backdrop",
					onClick: closePracticeTest
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: activePracticeTest.title }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
								"Chủ đề: ",
								activePracticeTest.theme,
								". Mỗi paper có một nội dung đề riêng; câu hỏi bên dưới không lặp lại bài đọc hoặc bài nghe."
							] })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "exam-work-list",
							children: activePracticeTest.papers.map((paper) => {
								const material = testMaterial(activePracticeTest, paper);
								const paperAudioKey = `${activePracticeTest.id}-work-${paper.paper}`;
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
									className: "exam-work-paper",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "exam-work-head",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: paper.paper }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: paper.time })]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "test-material paper-material",
											children: [
												...
												paper.paper.includes("Nghe") && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
													type: "button",
													onClick: () => playTestAudio(paperAudioKey, material.text),
													children: testAudioKey === paperAudioKey ? "Dừng audio" : "▶ Nghe audio"
												})
											]
										}),
										paper.items.map((item) => {
											const answerKey = `${activePracticeTest.id}-${item.part}-${item.sampleQuestion}`;
											const userAnswer = testAnswers[answerKey] ?? "";
											const isSelfMarked = item.answerKey === "học viên tự trả lời";
											const isCorrect = userAnswer.trim().toLowerCase() === item.answerKey.trim().toLowerCase();
											return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
												className: "exam-work-item",
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: item.part }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("em", { children: examTaskType(item) })] }),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: examInstruction(paper.paper, item) }),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExamIllustration, {
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: item.sampleQuestion }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
														value: userAnswer,
														onChange: (event) => updateTestAnswer(answerKey, event.target.value),
														placeholder: isSelfMarked ? "Write your answer in English. Use the exam criteria to self-check." : "Type your answer in English..."
													})] }),
													testChecked && !isSelfMarked && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
														className: `answer-feedback ${isCorrect ? "correct" : "wrong"}`,
														children: isCorrect ? "Correct" : `Try again. Suggested answer: `
													}),
													testChecked && isSelfMarked && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
														className: "answer-feedback self",
														children: [
															"This answer should be self-checked. Focus: ",
															examFocus(item),
															"."
														]
													})
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								className: "button primary",
								type: "button",
								onClick: () => setTestChecked(true),
								children: "Check answers"
							}), testChecked && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("strong", { children: [
								"Auto score: ",
								testScore,
								"/",
								gradableItems.length,
