...
function testMaterial(test, paperName, item) {
	const theme = test.theme.toLowerCase();
	if (paperName.includes("Nghe")) return {
		label: "Nội dung nghe",
	...
	if (paperName.includes("Đọc") || paperName.includes("Viết") || paperName.includes("Sử dụng")) return {
		label: "Nội dung đề",
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: activePracticeTest.papers.map((paper) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: paper.paper }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: paper.time })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: paper.items.map((item) => {
										const material = testMaterial(activePracticeTest, paper.paper, item);
										const audioKey = `${activePracticeTest.id}-${paper.paper}-${item.part}`;
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
								"Chủ đề: ",
								activePracticeTest.theme,
								". Mỗi phần có nội dung đề, câu hỏi và ô trả lời. Phần nghe có nút phát audio bằng giọng đọc trình duyệt."
							] })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "exam-work-list",
							children: activePracticeTest.papers.map((paper) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									const audioKey = `${activePracticeTest.id}-work-${paper.paper}-${item.part}`;
									const material = testMaterial(activePracticeTest, paper.paper, item);
